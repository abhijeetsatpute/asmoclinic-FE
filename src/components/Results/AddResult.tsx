...
import ResultImageUpload from "./Gallery/Form/ResultImageUpload";
...
const AddImage: React.FC = () => {
  ...
  const before = useResultStore((state: any) => state.before);
  const after = useResultStore((state: any) => state.after);
